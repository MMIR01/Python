...
class Company:
    ...
    # Protected method
    # Using a single _ to indicate the name of a private method in a Python class, it
    # is just a naming convention and it's not enforced by the Python interpreter
